...
review_llm = ChatGroq(model="openai/gpt-oss-120b", temperature=0.2)
...
def review_node(state: State) -> dict:
    ...
    response = review_llm.invoke([("human",prompt),("system",REVIEWER_SYSTEM_PROMPT)])
