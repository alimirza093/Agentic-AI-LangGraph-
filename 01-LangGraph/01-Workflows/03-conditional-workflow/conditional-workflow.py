...
llm_model = ChatMistralAI(model = 'open-mistral-7b',temperature=0.4)
...
academic_retriever = build_retriever('01-LangGraph/01-Workflows/academics_handbook.pdf')
fee_retriever = build_retriever('01-LangGraph/01-Workflows/fee_structure.pdf')
...
graph.add_node("academic",academic_rag_node)
graph.add_node("fee",fee_rag_node)
